...
class ClosexButton extends StatefulWidget {
  const ClosexButton(this.onPressed);

  final VoidCallback onPressed;

  @override
  ClosexButtonState createState() {
    return ClosexButtonState();
  }
}

class ClosexButtonState extends State<ClosexButton> {
